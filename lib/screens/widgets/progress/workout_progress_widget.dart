  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(type, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: textColor)),
                  const SizedBox(height: 8),
                  Text('$target menit', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: textColor)),
                  const SizedBox(height: 8),
        ...
        // ... (Sama, copy bagian bawah dari file widget sebelumnya)
              ...
              Stack(
                ...
                children: [
                  SizedBox(
                    ...
                    child: CircularProgressIndicator(value: percent, strokeWidth: 14, backgroundColor: const Color(0xFF2B3648), valueColor: const AlwaysStoppedAnimation<Color>(Colors.deepPurpleAccent), strokeCap: StrokeCap.round),
                  ),
                  Column(
                    children: [
                      ...
                      Text('$current', style: const TextStyle(color: Colors.deepPurpleAccent, fontSize: 32, fontWeight: FontWeight.bold)),
                    ],
                  )
                ],
              ),
              const SizedBox(height: 24),
              Text('Hari ini kamu sudah mencapai $current/$target menit.', style: const TextStyle(color: Colors.white70, fontSize: 12)),
